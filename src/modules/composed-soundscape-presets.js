...
export const COMPOSED_SOUNDSCAPE_PRESETS = Object.freeze([
  normalizeComposedPreset({
    ...
    description: 'Long dub delays, resonant phaser motion, and drifting wet reverb for evolving nebula-like fields.',
    tags: ['dub', 'drone', 'atmosphere', 'feedback'],
    sources: [
      { id: 'nebula-pad', moduleType: 'wavetablesynth', preset: 'br-inspired-rain-pad', role: 'bed' },
      { id: 'nebula-chirps', moduleType: 'fmsynth', preset: 'experimental-r2d2-voice', role: 'sparkle' },
    ],
    effectChain: [
      { id: 'nebula-delay', type: 'delay', params: { time: 0.72, feedback: 0.62, wet: 0.5, tone: 3600 } },
    ...
    automation: {
      lengthBars: 32,
      lanes: [
        lane('nebula-delay', 'feedback', 0.62, [{ type: 'lfo', startBeat: 0, endBeat: 128, min: 0.38, max: 0.88, cycles: 2 }]),
        lane('nebula-dub', 'tone', 1800, [{ type: 'linear', startBeat: 0, endBeat: 128, from: 900, to: 4200 }]),
        lane('nebula-phaser', 'rate', 0.07, [{ type: 'lfo', startBeat: 0, endBeat: 128, min: 0.025, max: 0.22, cycles: 5 }]),
        lane('nebula-reverb', 'wet', 0.72, [{ type: 'lfo', startBeat: 0, endBeat: 128, min: 0.45, max: 0.9, cycles: 1 }]),
      ],
    },
    routing: [
  ...
  normalizeComposedPreset({
    ...
    description: 'Aggressive laser FM source through pitch shift, flanger, grain delay, and feedback diffusion.',
    tags: ['laser', 'storm', 'feedback', 'experimental'],
    sources: [
      { id: 'ion-laser', moduleType: 'fmsynth', preset: 'experimental-tie-fighter-laser', role: 'exciter' },
      { id: 'ion-noise', moduleType: 'wavetablesynth', preset: 'experimental-cracking-noises', role: 'static' },
    ],
    effectChain: [
      ...
      { id: 'ion-grain', type: 'graindelay', params: { grainSize: 0.04, spray: 0.045, feedback: 0.64, wet: 0.72 } },
      { id: 'ion-reverb', type: 'reverb', params: { wet: 0.55, size: 0.72, tone: 5200 } },
    ],
    automation: {
      lengthBars: 16,
      lanes: [
        lane('ion-pitch', 'semitones', -7, [{ type: 'step', startBeat: 0, value: -7 }, { type: 'step', startBeat: 32, value: 5 }]),
        lane('ion-grain', 'spray', 0.045, [{ type: 'lfo', startBeat: 0, endBeat: 64, min: 0.01, max: 0.08, cycles: 7 }]),
        lane('ion-flanger', 'rate', 0.18, [{ type: 'linear', startBeat: 0, endBeat: 64, from: 0.04, to: 1.2 }]),
        lane('ion-reverb', 'tone', 5200, [{ type: 'lfo', startBeat: 0, endBeat: 64, min: 1400, max: 9000, cycles: 3 }]),
      ],
    },
  ...
  normalizeComposedPreset({
    ...
    sources: [{ id: 'water-drop', moduleType: 'wavetablesynth', preset: 'experimental-water-drop', role: 'droplet' }],
    effectChain: [
      { id: 'water-grain', type: 'graindelay', params: { grainSize: 0.026, spray: 0.03, feedback: 0.52, wet: 0.68 } },
    ...
    automation: {
      lengthBars: 24,
      lanes: [
        lane('water-grain', 'grainSize', 0.026, [{ type: 'lfo', startBeat: 0, endBeat: 96, min: 0.01, max: 0.12, cycles: 6 }]),
        lane('water-dub', 'feedback', 0.7, [{ type: 'lfo', startBeat: 0, endBeat: 96, min: 0.25, max: 0.86, cycles: 2 }]),
        lane('water-reverb', 'size', 0.9, [{ type: 'linear', startBeat: 0, endBeat: 96, from: 0.45, to: 0.95 }]),
      ],
    },
  ...
  normalizeComposedPreset({
    ...
    sources: [{ id: 'radio-crackle', moduleType: 'wavetablesynth', preset: 'experimental-cracking-noises', role: 'texture' }],
    effectChain: [
      { id: 'radio-repeat', type: 'beatrepeat', params: { feedback: 0.72, wet: 0.62, repeat: 0.125 } },
      { id: 'radio-phaser', type: 'phaser', params: { rate: 0.11, depth: 650, wet: 0.55 } },
      { id: 'radio-delay', type: 'delay', params: { time: 0.43, feedback: 0.58, wet: 0.52, tone: 1200 } },
    ],
    automation: {
      lengthBars: 12,
      lanes: [
        lane('radio-repeat', 'repeat', 0.125, [{ type: 'step', startBeat: 0, value: 0.125 }, { type: 'step', startBeat: 24, value: 0.0625 }]),
        lane('radio-phaser', 'depth', 650, [{ type: 'lfo', startBeat: 0, endBeat: 48, min: 120, max: 1100, cycles: 4 }]),
        lane('radio-delay', 'tone', 1200, [{ type: 'lfo', startBeat: 0, endBeat: 48, min: 500, max: 3800, cycles: 2 }]),
      ],
    },
  ...
  normalizeComposedPreset({
    ...
    description: 'Cinematic rain-pad and dream-lead sources through long dub/reverb feedback fields.',
    tags: ['cinematic', 'rain', 'drone', 'vangelis-inspired'],
    sources: [
      { id: 'rain-pad', moduleType: 'wavetablesynth', preset: 'br-inspired-rain-pad', role: 'pad' },
      { id: 'dream-lead', moduleType: 'analogsynth', preset: 'br-inspired-dream-lead', role: 'lead' },
    ],
    effectChain: [
      { id: 'rain-delay', type: 'delay', params: { time: 1.1, feedback: 0.56, wet: 0.46, tone: 2800 } },
    ...
    automation: {
      lengthBars: 64,
      lanes: [
        lane('rain-delay', 'time', 1.1, [{ type: 'lfo', startBeat: 0, endBeat: 256, min: 0.66, max: 1.33, cycles: 2 }]),
        lane('rain-dub', 'feedback', 0.82, [{ type: 'lfo', startBeat: 0, endBeat: 256, min: 0.48, max: 0.9, cycles: 3 }]),
        lane('rain-reverb', 'wet', 0.9, [{ type: 'linear', startBeat: 0, endBeat: 256, from: 0.55, to: 0.95 }]),
      ],
    },
...
export function exportComposedPresetBankJson(presets = COMPOSED_SOUNDSCAPE_PRESETS) {
  return JSON.stringify({ schemaVersion: 1, type: 'v11.composed-soundscape-preset-bank', presets }, null, 2);
}
